...
const Icons = {
  ...
  sparkles: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3zM5 19l1 3 1-3 3-1-3-1-1-3-1 3-3 1 3 1z"/></svg>',
  ...
  video: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 7l-7 5 7 5V7z"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg>',
  ...
  /** 侧栏 Logo：简报折角 + 播放符，纯白图形衬在主题渐变底上 */
  brandMark:
    '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7 26V8h13l6 6v14H7z" fill="none" stroke="#ffffff" stroke-width="2" stroke-linejoin="round"/><path d="M20 8v6h6" fill="none" stroke="#ffffff" stroke-width="2" stroke-linejoin="round"/><path stroke="#ffffff" stroke-width="1.8" stroke-linecap="round" d="M11 15h10M11 19h8"/><polygon fill="#ffffff" points="21,11 28,16 21,21"/></svg>',
  trash: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M8 6V4h8v2M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6"/></svg>',
  ...
  el(name, cls = 'icon') {
    return `<span class="${cls}" aria-hidden="true">${this[name] || ''}</span>`;
  },
};
